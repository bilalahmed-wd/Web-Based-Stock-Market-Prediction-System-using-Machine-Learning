...
<head>
    ...
    <body >
        ...
        <!-- End Navigation Bar-->
                      ...
                      <!-- Start Home -->        
        <section class="bg-home" style="background-image:url('theme/images/black-and-white-newspaper-stock-exchange-stock-market-102152.jpg'); background-repeat:no-repeat;">
...
<div class="card-header py-3">
  <h6 class="m-0 font-weight-bold text-dark">Contact us</h6>
  <h3 class="m-0 font-weight-bold text-dark">Address</h3>
  <p>Sialkot,Pakistan,Punjab,51310</p>
<h3 class="m-0 font-weight-bold text-dark">Phone Numbers</h3>
<p class="m-0 font-weight-bold text-dark">+92332-9122007</p>
<p class="m-0 font-weight-bold text-dark">+92335-0465075</p>
<p class="m-0 font-weight-bold text-dark">+92302-7528478</p>
</div>
</div>
                </div><!--end col-->
            </div><!--end row-->

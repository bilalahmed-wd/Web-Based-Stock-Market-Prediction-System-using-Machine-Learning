          ...
          foreach($importData_arr as $data){
             if($skip != 0){
              ...
              $stockDate=date('Y-m-d',strtotime($stockDate));
                ...
                $sql = "select count(*) as allcount from stockpredictions where stockDate='" . $stockDate . "' and stockOpen='" . $stockOpen . "' and  stockHigh='" . $stockHigh . "' and stockLow='" . $stockLow . "' and stockClose='" . $stockClose . "' and adjClose='" . $adjClose . "' and volume='" . $volume . " 'and est_N5='" . $est_N5 . "' ";
                ...
                if($count == 0){
                   // Insert record  
                   $insertStockPredictions = "INSERT into stockpredictions (stockDate,stockOpen,stockHigh,stockLow,stockClose,adjClose,volume,est_N5,userId)
                   values ('$stockDate',$stockOpen,$stockHigh,$stockLow,$stockClose,$adjClose,$volume,$est_N5,$userId )";
                   if(mysqli_query($con, $insertStockPredictions) == 1){
                      
                    
                    echo '<script>
                    window.onload = function () { alert("Stock Predictions Result Added Successful"); } 
                   </script>';
                  }        
                ...
                {
                    echo '<script>
                     window.onload = function () { alert("Stock Predictions Result Added Unsuccessful"); } 
...
<!-- End of Topbar -->
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Stock Predictions </h1>
          </div>

<?php
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `user` WHERE userName='$userName'and password='$password' and userType = 'admin' ";
        ...
        if($rows==1){
			...
			header("Location: index.php"); // Redirect user to index.php
                ...
                echo '<script>
                window.onload = function () { alert("Invalid AdminName or Password"); } 
               </script>';
				}
    }
?>
...
<head>
    ...
    <body>
        ...
        <div class="back-to-home d-none d-sm-block">
            <a href="http://localhost/stocker.pk/" class="text-white"><i class="pe-7s-home"></i></a>
        </div>
                            ...
                            <div class="col-lg-5 col-md-7">
                                <div class="login bg-white rounded p-4">
                                    ...
                                    <a href="http://localhost/stocker.pk/" class="logo text-dark">
											<div >
												<img src="http://localhost/stocker.pk/admin/img/logo.png" alt="missing_logo" height="100">
											</div>

										</a>
                                        
                                        <h4 class="title text-uppercase mt-3 mb-4">Enter Admin Login Details</h4>  
                                    </div>
                                    <form class="login-form" action="" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <button class="btn btn-custom w-100" type="submit" name="login" value="submit">Sign in</button>
                                            </div>
